...
These protocols essentially broadcast to the entire local network: _"Does anyone know who FILSERVER is?"_ — and that's where the attacker steps in.
...
![Responder start](../../.gitbook/assets/02-responder-start.png)
...
![Responder captures s.vim hash](../../.gitbook/assets/07-responder-svim-hash.png)
...
![Hashcat running](../../.gitbook/assets/08-hashcat-start.png)

![Hashcat cracked](../../.gitbook/assets/09-hashcat-cracked.png)
